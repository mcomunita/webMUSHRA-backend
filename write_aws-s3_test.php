...
$bucketName = 'webmushra-results';  // Replace with your S3 bucket name
$region = 'eu-north-1';     // Replace with your S3 bucket region
$accessKey = 'AKIAT7JJUZWHORJRGIOU';     // Replace with your Access Key ID
$secretKey = 'EUbICvirjfaH2rSGRYbL9DSJJemlVa+lT1df76LC';     // Replace with your Secret Access Key
$filepathPostfix = ".csv";
